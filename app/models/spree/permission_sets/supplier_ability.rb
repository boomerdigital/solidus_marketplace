  ...
  module PermissionSets
    class SupplierAbility < PermissionSets::Base
      ...
      def activate!
        ...
        can [:admin, :display, :index, :update, :edit], Spree::Shipment, order: {state: 'complete'},
        ...
        can [:admin, :index, :edit, :update, :cancel, :show, :cart, :resend, :fire, :approve], Spree::Order, stock_locations: { supplier_id: user.supplier_id }
